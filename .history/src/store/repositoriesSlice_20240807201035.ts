  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchRepositories.pending, (state) => {
        ...
        console.log("Fetching repositories..."); // Логирование состояния загрузки
      })
      .addCase(fetchRepositories.fulfilled, (state, action) => {
        state.status = "idle";
        state.repositories = action.payload;
        console.log("Repositories fetched successfully:", action.payload); // Логирование успешного получения данных
      })
